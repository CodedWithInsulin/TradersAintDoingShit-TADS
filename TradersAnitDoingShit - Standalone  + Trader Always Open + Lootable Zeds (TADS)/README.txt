...
- move 1 folder in "TradersAnitDoingShit - Standalone + Trader Always Open (TADS)" -> "TradersAintDoingShit (TADS Standalone)"
- open "Put inside in PREFABS" with Winrar or 7-zip
- open "7 Days to die ROOT" -> "Data" -> "Prefabs"
- with the zip file called "Mods" drag and drop inside in "7 Days to die ROOT"
